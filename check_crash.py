...
def check():
    ...
    if pid == 0:
        ...
        commands = [
            "echo '=== JOURNAL LOGS FOR CRASH REASON ==='",
            f"echo '{REMOTE_PWD}' | sudo -S journalctl -u sjvn-platform -n 40 --no-pager",
            "echo '=== RUNNING NODE DIRECTLY IN TERMINAL TO SEE ERROR ==='",
            "cd /home/user01/sjvn-energy-platform/backend",
            "node src/server.js",
            "exit"
        ]

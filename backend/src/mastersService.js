...
const DEFAULT_PARAMS = [
  ...
  { category: 'TRADING', param_key: 'iex_environment', param_value: 'UAT', data_type: 'TEXT', unit: '', description: 'Which IEX environment iex_base_url points at — UAT (alpha) or LIVE. Labels the data on screen so a UAT figure is never mistaken for a traded one.' },

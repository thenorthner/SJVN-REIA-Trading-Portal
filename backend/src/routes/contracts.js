  ...
  db.transaction(() => {
    db.prepare(`
      INSERT INTO contracts (id, contract_no, contract_type, seller_id, buyer_id, project_type, capacity_mw, commissioned_capacity_mw, cod_date,
        tariff_type, tariff_per_unit, tariff_structure_json, tenure_start, tenure_end, billing_cycle, payment_terms, emd_amount, pbg_amount, pbg_type, pbg_expiry, rebate_rule, lps_rule, payment_security_type, trading_margin_per_mwh, status)
  ...
  db.transaction(() => {
    db.prepare(`
      INSERT INTO contracts (id, contract_no, contract_type, seller_id, buyer_id, project_type, capacity_mw, commissioned_capacity_mw, cod_date,
        ...
        pbg_expiry, rebate_rule, lps_rule, payment_security_type, trading_margin_per_mwh, version, parent_contract_id, status, remarks)
      VALUES (@id, @contract_no, @contract_type, @seller_id, @buyer_id, @project_type, @capacity_mw, @commissioned_capacity_mw, @cod_date,
        @tariff_type, @tariff_per_unit, @tariff_structure_json, @tenure_start, @tenure_end, @billing_cycle, @payment_terms, @emd_amount, @pbg_amount, @pbg_type,
        @pbg_expiry, @rebate_rule, @lps_rule, @payment_security_type, @trading_margin_per_mwh, @version, @parent_contract_id, 'ACTIVE', @remarks)
    `).run({
      ...updated,
      id: newVersionId,

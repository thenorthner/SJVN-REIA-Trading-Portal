...
router.get('/', requireRole('SELLER', 'SJVN_ADMIN'), (req, res) => {
  ...
  if (contractIds.length === 0) {
    return res.json({
      ...
      total_invoices: 0, pending_approval: 0, paid_invoices: 0, overdue_invoices: 0,
      total_billed: 0, total_received: 0, pending_amount: 0,
  ...
  res.json({
    ...
    pending_approval: invStats.pending_approval,

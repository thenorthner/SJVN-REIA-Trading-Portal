...
def open_port():
    ...
    if pid == 0:
        ...
        commands = [
            f"echo '{REMOTE_PWD}' | sudo -S ufw allow 4000/tcp || true",
            f"echo '{REMOTE_PWD}' | sudo -S ufw allow 80/tcp || true",
            f"echo '{REMOTE_PWD}' | sudo -S iptables -I INPUT -p tcp --dport 4000 -j ACCEPT || true",
            f"echo '{REMOTE_PWD}' | sudo -S iptables -I INPUT -p tcp --dport 80 -j ACCEPT || true",
            "exit"
        ]

...
const PxilReports = lazy(() => import('./pages/trading/PxilReports.jsx'));
  ...
  return (
    ...
    <Routes>
      ...
      >
        ...
        <Route path="trading/pxil/reports" element={<ProtectedRoute roles={TRADING_INTERNAL_ROLES}><PxilReports /></ProtectedRoute>} />
